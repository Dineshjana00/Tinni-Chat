...
API_ID = int(getenv("API_ID", "23897179"))
API_HASH = getenv("API_HASH", "af77c773213760ddbb98a9f17df5c642")
BOT_TOKEN = getenv("BOT_TOKEN", None)
OWNER_ID = int(getenv("OWNER_ID", "6592050015"))
MONGO_URL = getenv("MONGO_URL", None)
SUPPORT_GRP = getenv("SUPPORT_GRP", "crazzysuport")
UPDATE_CHNL = getenv("UPDATE_CHNL", "GAmovie_channel")
